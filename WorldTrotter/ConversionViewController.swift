...
class ConversionViewController: UIViewController, UITextFieldDelegate {
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        let legalChars = NSCharacterSet(charactersIn: "1234567890.+-")
...
//    func textField(_ jank: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
//        print("test")
//        return true
//    }
